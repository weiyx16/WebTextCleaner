"""
Thanks: https://github.com/shjwudp/c4-dataset-script; mainly use the massivetext_utils.py
Check the percentage of duplicate content in the web document, and the program will remove documents whose duplicate proportion exceeds the preset threshold.
python repetition_removal.py \
        --input clean_docs.jsonl \
        --output ./repetition_removal_output

The methods used in Gopher
"""
import argparse
import nltk
import hashlib
